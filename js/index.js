...
/* document.addEventListener('DOMContentLoaded', function() {
  // Capturar el clic del elemento <a>
  document.addEventListener('click', function(event) {
    if (event.target && event.target.classList.contains('btn')) {
      // Acceder al elemento <a> que ha sido clicado
      var link = event.target;
      var eventId = link.id; // Obtener el ID del evento desde el atributo id del enlace
      var redirect = "details.html?id=" + eventId; // Construir la URL de redirección correctamente con el ID
      window.location.href = redirect; // Redirigir a la página "details.html" con el ID en la URL
